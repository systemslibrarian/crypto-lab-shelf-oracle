...
export const CATALOG: readonly ShelfEntry[] = [
  ...
  { id: 3, title: 'Jane Eyre', author: 'Charlotte Brontë', year: '1847', lcClass: 'PR', className: 'English literature', note: 'A first-person account of a governess, first issued under the pen name Currer Bell.' },
  { id: 4, title: 'Wuthering Heights', author: 'Emily Brontë', year: '1847', lcClass: 'PR', className: 'English literature', note: 'A nested frame narrative of two Yorkshire households, published as by Ellis Bell.' },
  ...
  { id: 34, title: 'The Prince', author: 'Niccolò Machiavelli', year: '1532', lcClass: 'JC', className: 'Political theory', note: 'Written around 1513 and printed five years after its author’s death.' },
  ...
  { id: 41, title: 'Philosophiæ Naturalis Principia Mathematica', author: 'Isaac Newton', year: '1687', lcClass: 'QA', className: 'Mathematics', note: 'States the laws of motion and universal gravitation in the geometric style of classical proof.' },
  { id: 42, title: 'On the Origin of Species', author: 'Charles Darwin', year: '1859', lcClass: 'QH', className: 'Natural history and biology', note: 'Its print run of 1,250 copies was taken up by the trade on the day of issue; five further editions followed.' },
  ...
  { id: 46, title: 'Micrographia', author: 'Robert Hooke', year: '1665', lcClass: 'QH', className: 'Natural history and biology', note: 'Observation XVIII, on thin sections of cork, introduced the word "cell" to biology; the fold-out flea is its most famous plate.' },
  { id: 47, title: 'The Interpretation of Dreams', author: 'Sigmund Freud', year: '1899', lcClass: 'BF', className: 'Psychology', note: 'Dated 1900 on its title page though it appeared in November 1899; the small first printing sold very slowly.' },
  ...
  { id: 49, title: 'Les Misérables', author: 'Victor Hugo', year: '1862', lcClass: 'PQ', className: 'Romance literatures', note: 'Published simultaneously in several cities; contains a long digression on the Paris sewers.' },
